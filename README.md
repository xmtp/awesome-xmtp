...
- 🛒 [TheGeneralStore](https://github.com/fabriguespe/thegeneralstore-bot) `thegeneralstore.eth`: Hackathon e-commerce store store that can list items and take orders.
